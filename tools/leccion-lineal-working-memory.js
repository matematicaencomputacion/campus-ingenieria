...
(function () {
  ...
  var audioCtl = window.CampusL200Audio && window.CampusL200Audio.mount
    ? window.CampusL200Audio.mount({
        root: document.getElementById("l200AudioSlots"),
        overlay: document.getElementById("l200Subtitles")
      })
    : {
        candidates: function () { return []; },
  ...
  window.__L200 = {
    ...
    audioCandidates: function (id) {
      return audioCtl.candidates(id == null ? "1" : id);
    },
    cueCandidates: function (id) {
      return audioCtl.cueCandidates(id == null ? "1" : id);
    },
    audioMuted: function (id) {
      return audioCtl.muted(id == null ? "1" : id);
    },
    ...
    setAudioCues: function (id, raw) {
      return audioCtl.setCues(id == null ? "1" : id, raw);
    },
    syncSubtitles: function (id, time) {
      if (arguments.length < 2) {
        time = id;
        id = "1";
      }
      return audioCtl.sync(id, time);
    },
    subtitleText: function () {
      return audioCtl.subtitleText();
    }
  };
})();
