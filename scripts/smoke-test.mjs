...
console.log('\n🎧 9. L200 (tabla, Sonido y audio local):');
{
  ...
  assert(l200.includes('l200-audio.js?v=20260910-probe'), 'L200 cache-bust audio JS ?v=20260910-probe');
  assert(!fs.existsSync(path.join(ROOT, 'tools/audio/l200/200_1.ogg')), 'Explicación 1 no duplica ogg junto al mp3');
  assert(l200.includes('leccion-lineal-working-memory.js?v=20260910-subs'), 'L200 cache-bust JS ?v=20260910-subs');
  ...
  assert(l200Audio.includes('200_') && l200Audio.includes('.wav') && l200Audio.includes('.json'), 'JS arma rutas 200_N');
