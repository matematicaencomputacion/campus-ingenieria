...
console.log('\n🧩 10. L199 Plantilla shell (ejes, rieles y placeholders):');
{
  ...
  assert(l199.includes('plantilla-shell.css?v=20260910-l199d'), 'L199 cache-bust CSS ?v=20260910-l199d');
  assert(l199.includes('plantilla-shell.js?v=20260910-l199d'), 'L199 cache-bust JS ?v=20260910-l199d');
