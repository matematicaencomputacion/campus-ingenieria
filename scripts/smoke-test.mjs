...
console.log('\n🧩 10. L199 Plantilla shell (ejes, rieles y placeholders):');
{
  ...
  assert(l199.includes('plantilla-shell.css?v=20260910-l199e'), 'L199 cache-bust CSS ?v=20260910-l199e');
  assert(l199.includes('plantilla-shell.js?v=20260910-l199e'), 'L199 cache-bust JS ?v=20260910-l199e');
  ...
  assert(!shellJs.includes(' ▾'), 'JS no arma rieles como desplegable Colores ▾');
