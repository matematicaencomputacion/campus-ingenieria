...
La forma fácil SHALL mostrar origen, P1, P2 y el recorrido horizontal/vertical con margen, en un lienzo de aproximadamente un tercio del alto original en escritorio. En móvil SHALL conservar al menos 240 px de alto.
